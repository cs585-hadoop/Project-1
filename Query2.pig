...
trans = LOAD 'hdfs://localhost:8020/user/hadoop/dft/transaction.csv' USING PigStorage(',') as (transID:chararray,cusID:chararray,transTotal:float,transNum:int,transDesc:chararray);
...
STORE final INTO 'pigresult2' USING PigStorage(',');
